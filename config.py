...
DEFAULT_CORRELATION_MATRIX = np.array([
    ...
    # US=0.88 (vs 0.95 theoretical), EAFE=0.83 (vs 0.90), EM=0.75 (vs 0.82)
    [ 1.00, 0.75, 0.70, 0.60,-0.15, 0.10,-0.05, 0.35, 0.30, 0.55, 0.30, 0.30, 0.00, 0.68],
    [ 0.75, 1.00, 0.80, 0.65,-0.20, 0.05,-0.10, 0.30, 0.25, 0.60, 0.35, 0.25, 0.00, 0.88],
    [ 0.70, 0.80, 1.00, 0.70,-0.10, 0.08,-0.05, 0.30, 0.28, 0.55, 0.30, 0.28, 0.00, 0.83],
    [ 0.60, 0.65, 0.70, 1.00,-0.05, 0.10, 0.00, 0.25, 0.22, 0.50, 0.25, 0.35, 0.00, 0.75],
    ...
    [ 0.68, 0.88, 0.83, 0.75,-0.15,-0.05,-0.10, 0.40, 0.30, 0.55, 0.35, 0.30,-0.10, 1.00],
])
